    ...
    <div>
        ...
        <div className="mx-auto">
          <Slider {...settings} className="w-full">
            <div className="w-full">
              <img src="./image/banner-1.jpg" alt="" className="w-full" />
            </div>
            <div className="w-full">
              <img src="./image/banner-4.jpg" alt="" className="w-full" />
            </div>
            <div className="w-full">
              <img src="./image/banner-3.jpg" alt="" className="w-full" />
            </div>
          </Slider>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="max-w-screen-xl mx-auto">
          <h1 className="mb-10 text-3xl font-semibold border-b-4 border-blue-900">All Products</h1>
          <div className="flex flex-col md:flex-row">
            ...
            <div className="my-products-right pl-0 md:pl-12 w-full md:w-9/12">
              ...
              <div className="products-bottom mt-5 mb-10">
                <img src="./image/products-bottom.jpg" alt="" className="border-8 border-blue-900 fade-right" />
                <div className="product-description">
                  <p className="py-5 px-5 border-30 border-emerald-100 text-lg font-normal text-dark leading-10">Cotton Comber Noil is one of the finest qualities of cotton waste. Comber Noil is a by-product of the combed cotton yarn spinning industry produced when cotton is combed to remove short fibers. We provide the best quality of comber Noil which is defect-free and pure cotton.</p>
                </div>
                <div className="product-description border-30 border-emerald-100">
                ...
                <div className="myProductspec border-30 border-emerald-100">
                    ...
                    <table className="w-full border-collapse border border-slate-400 text-lg">
                      <tbody>
                        <tr className="border border-slate-300">
                          <td className="border border-slate-300 p-2 bg-blue-50 text-blue-900 font-semibold">Variety</td>
