    ...
    <div>
      ...
      <section className='hero slider w-lg'>
        <div >
          <Slider {...settings}>
            <div >
              <img src="./public/image/swastikcottonfiber slider7.jpg" alt="" />
            </div>
            <div>
              <img src="./public/image/swastikcottonfiber slider5.jpg" alt="" />
            </div>
            <div>
              <img src="./public/image/swastikcottonfiber slider6.jpg" alt="" />
            </div>
          </Slider>
        </div>
      </section>
            ...
            <Tabs.Group className='border-0'>
              ...
              active
               ...
               <div className='grid grid-cols-3  text-lg text-blue-900'>
                 ...
                 <img src="./public/image/COTTON WASTE 3.png" alt="" className='w-3/4  h-auto border-2 border-solid  border-slate-200 rounded-md p-8 ' />
               </div>
              </Tabs.Item>
              <Tabs.Item title="cotton yarn">
                <div  className='grid grid-cols-3  text-lg text-blue-900'>
                  ...
                  <img src="./public/image/products-bg.jpg" alt=""  className='w-3/4  h-auto border-2 border-solid  border-slate-200 rounded-md p-8 ' />
                </div>
              </Tabs.Item>
              <Tabs.Item title="Indian Raw Cotton">
                <div  className='grid grid-cols-3 text-lg text-blue-900'>
                  ...
                  <img src="./public/image/Masthead-Cotton.png" alt="" className='w-3/4  h-auto border-2 border-solid  border-slate-200 rounded-md p-8'  />
                </div>
              </Tabs.Item>
            </Tabs.Group>
          </div>
