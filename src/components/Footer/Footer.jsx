  ...
  <div className="container mx-auto">
    <div className="flex flex-col md:flex-row items-center justify-between">
      <div className="mb-4 sm:mb-0 text-center">
        <h2 className="text-lg font-semibold text-center">Address</h2>
        <p className='text-center'>Sr. No.25/1, Nr Triveni Ashram, Botad-Bhavnagar Road, <br /> Samadhiyala No.1, Botad, Gujarat 364710, India</p>
      </div>
      <div className="mb-4 sm:mb-0 text-center">
    ...
    <div className="flex flex-col md:flex-row items-center justify-center"> {/* Centering content */}
      <p className="mb-4 md:mb-0 text-center ">&copy; Copyright Swastik cotton fiber. All Rights Reserved</p>
